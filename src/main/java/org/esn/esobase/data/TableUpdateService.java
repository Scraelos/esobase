...
public class TableUpdateService {
    ...
    public void updateAbilityDescriptions() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsachievementdescription_id in(select g.id from gspreadsheetsachievementdescription g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsabilitydescription set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsabilitydescription.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsabilitydescription.aid and e.bid=gspreadsheetsabilitydescription.bid and e.cid=gspreadsheetsabilitydescription.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsabilitydescription (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsabilitydescription g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(132143172) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateAchievementDescriptions() {
        ...
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsachievementdescription_id in(select g.id from gspreadsheetsachievementdescription g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsachievementdescription set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsachievementdescription.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsachievementdescription.aid and e.bid=gspreadsheetsachievementdescription.bid and e.cid=gspreadsheetsachievementdescription.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsachievementdescription (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsachievementdescription g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(188155806) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateAchievements() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsachievement_id in(select g.id from gspreadsheetsachievement g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsachievement set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsachievement.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsachievement.aid and e.bid=gspreadsheetsachievement.bid and e.cid=gspreadsheetsachievement.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsachievement (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsachievement g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(12529189,172030117) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateActivators() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsactivator_id in(select g.id from gspreadsheetsactivator g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsactivator set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsactivator.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsactivator.aid and e.bid=gspreadsheetsactivator.bid and e.cid=gspreadsheetsactivator.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsactivator (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsactivator g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(14464837,19398485,39619172,77659573,87370069,124318053,207758933,219936053) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateCollectibles() {
        Query q0 = em.createNativeQuery("with newid as (select g.id,e.aid,e.bid,e.cid from gspreadsheetscollectible g join esorawstring e on lower(regexp_replace(e.texten,'\\n','$','g'))=lower(g.texten) and e.aid in(18173141,70328405,160914197,245765621,213229525,204530069) order by e.aid asc,e.cid asc,e.bid asc) update gspreadsheetscollectible set deprecated=FALSE,aid=newid.aid,bid=newid.bid,cid=newid.cid,weight=newid.cid from newid where gspreadsheetscollectible.id=newid.id;");
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where sheetscollectible_id in(select g.id from gspreadsheetscollectible g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetscollectible set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetscollectible.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetscollectible.aid and e.bid=gspreadsheetscollectible.bid and e.cid=gspreadsheetscollectible.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetscollectible (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetscollectible g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(18173141,70328405,160914197,245765621,213229525,204530069) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateCollectibleDescriptions() {
        Query q0 = em.createNativeQuery("with newid as (select g.id,e.aid,e.bid,e.cid from gspreadsheetscollectibledescription g join esorawstring e on lower(regexp_replace(e.texten,'\\n','$','g'))=lower(g.texten) and e.aid in(211640654,263796174,86917166,69169806) order by e.aid asc,e.cid asc,e.bid asc) update gspreadsheetscollectibledescription set deprecated=FALSE,aid=newid.aid,bid=newid.bid,cid=newid.cid,weight=newid.cid from newid where gspreadsheetscollectibledescription.id=newid.id;");
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where sheetscollectibledescription_id in(select g.id from gspreadsheetscollectibledescription g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetscollectibledescription set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetscollectibledescription.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetscollectibledescription.aid and e.bid=gspreadsheetscollectibledescription.bid and e.cid=gspreadsheetscollectibledescription.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetscollectibledescription (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetscollectibledescription g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(211640654,263796174,86917166,69169806) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateItemDescriptions() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsitemdescription_id in(select g.id from gspreadsheetsitemdescription g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsitemdescription set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsitemdescription.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsitemdescription.aid and e.bid=gspreadsheetsitemdescription.bid and e.cid=gspreadsheetsitemdescription.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsitemdescription (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsitemdescription g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(27704788,139139780,228378404,249673710) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateItemNames() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsitemname_id in(select g.id from gspreadsheetsitemname g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsitemname set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsitemname.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsitemname.aid and e.bid=gspreadsheetsitemname.bid and e.cid=gspreadsheetsitemname.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsitemname (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsitemname g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(124362421,242841733,267697733) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateJournalEntrys() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsjournalentry_id in(select g.id from gspreadsheetsjournalentry g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsjournalentry set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsjournalentry.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsjournalentry.aid and e.bid=gspreadsheetsjournalentry.bid and e.cid=gspreadsheetsjournalentry.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsjournalentry (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsjournalentry g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(103224356) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateLoadscreens() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where sheetsloadscreen_id in(select g.id from gspreadsheetsloadscreen g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsloadscreen set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsloadscreen.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsloadscreen.aid and e.bid=gspreadsheetsloadscreen.bid and e.cid=gspreadsheetsloadscreen.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsloadscreen (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsloadscreen g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(4922190,70901198,153349653) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateLocationNames() {
        ...
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetslocationname_id in(select g.id from gspreadsheetslocationname g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
    ...
    public void updateNotes() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsnote_id in(select g.id from gspreadsheetsnote g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsnote set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsnote.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsnote.aid and e.bid=gspreadsheetsnote.bid and e.cid=gspreadsheetsnote.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsnote (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsnote g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(219317028) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateNpcNames() {
        Query q0 = em.createNativeQuery("with newid as (select g.id,e.aid,e.bid,e.cid from gspreadsheetsnpcname g left join esorawstring e on g.texten=regexp_replace(regexp_replace(e.texten,'\\^[FfMmNn]',''),'\\n','$','g') and ((g.sex!='U' and g.sex=substring(e.texten from '\\^([FfMmNn])')) or (g.sex='U' and substring(e.texten from '\\^([FfMmNn])') is null)) and e.aid in(8290981,51188660,191999749) order by e.aid asc,e.cid asc,e.bid asc) update gspreadsheetsnpcname set deprecated=FALSE,aid=newid.aid,bid=newid.bid,cid=newid.cid,weight=newid.cid from newid where gspreadsheetsnpcname.id=newid.id;");
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsnpcname_id in(select g.id from gspreadsheetsnpcname g join esorawstring e on e.aid=g.aid and e.bid=g.bid and e.cid=g.cid where g.texten!=regexp_replace(regexp_replace(e.texten,'\\^[FfMmNn]',''),'\\n','$','g') or (g.sex!='U' and g.sex!=substring(e.texten from '\\^([FfMmNn])')) or (g.sex='U' and substring(e.texten from '\\^([FfMmNn])') is not null));");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsnpcname set texten=regexp_replace(regexp_replace(e.texten,'\\^[FfMmNn]',''),'\\n','$','g'),textru=regexp_replace(regexp_replace(e.texten,'\\^[FfMmNn]',''),'\\n','$','g'),sex=substring(e.texten from '\\^([FfMmNn])'),changetime=null,translator=null,deprecated=false from esorawstring e where (gspreadsheetsnpcname.texten!=regexp_replace(regexp_replace(e.texten,'\\^[FfMmNn]',''),'\\n','$','g') or (gspreadsheetsnpcname.sex!='U' and gspreadsheetsnpcname.sex!=substring(e.texten from '\\^([FfMmNn])')) or (gspreadsheetsnpcname.sex='U' and substring(e.texten from '\\^([FfMmNn])') is not null)) and e.aid=gspreadsheetsnpcname.aid and e.bid=gspreadsheetsnpcname.bid and e.cid=gspreadsheetsnpcname.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("update gspreadsheetsnpcname set sex='U' where sex is null or sex='';");
        q3.executeUpdate();
        Query q4 = em.createNativeQuery("insert into gspreadsheetsnpcname select nextval('hibernate_sequence'),null,null,regexp_replace(regexp_replace(texten,'\\^[FfMmNn]',''),'\\n','$','g') as ten,regexp_replace(regexp_replace(texten,'\\^[FfMmNn]',''),'\\n','$','g') as ter, null,substring(texten from '\\^([FfMmNn])') as sex,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsnpcname g on lower(g.texten) = lower(regexp_replace(regexp_replace(e.texten,'\\^[FfMmNn]',''),'\\n','$','g')) and (lower(g.sex) = lower(substring(e.texten from '\\^([FfMmNn])')) or (g.sex='U' and substring(e.texten from '\\^([FfMmNn])') is null)) where e.aid in(8290981,51188660,191999749) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q4.executeUpdate();
    ...
    public void updateNpcPhrases() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsnpcphrase_id in(select g.id from gspreadsheetsnpcphrase g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsnpcphrase set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsnpcphrase.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsnpcphrase.aid and e.bid=gspreadsheetsnpcphrase.bid and e.cid=gspreadsheetsnpcphrase.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsnpcphrase (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsnpcphrase g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(3952276,55049764,115740052,116521668,149328292,165399380,200879108,211899940,234743124) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updatePlayerPhrases() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsplayerphrase_id in(select g.id from gspreadsheetsplayerphrase g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsplayerphrase set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsplayerphrase.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsplayerphrase.aid and e.bid=gspreadsheetsplayerphrase.bid and e.cid=gspreadsheetsplayerphrase.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsplayerphrase (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsplayerphrase g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(20958740,99155012,109216308,150525940,204987124,228103012,232026500,249936564,188095652) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateQuestDescriptions() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsquestdescription_id in(select g.id from gspreadsheetsquestdescription g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsquestdescription set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsquestdescription.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsquestdescription.aid and e.bid=gspreadsheetsquestdescription.bid and e.cid=gspreadsheetsquestdescription.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsquestdescription (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsquestdescription g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(265851556,205344756) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateQuestDirections() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsquestdirection_id in(select g.id from gspreadsheetsquestdirection g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsquestdirection set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsquestdirection.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsquestdirection.aid and e.bid=gspreadsheetsquestdirection.bid and e.cid=gspreadsheetsquestdirection.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsquestdirection (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select e.id from esorawstring e left join gspreadsheetsquestdirection g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(7949764,121487972,168415844,256430276) and g.id is null order by e.aid asc,e.cid asc,e.bid asc LIMIT 1);");
        q3.executeUpdate();
    ...
    public void updateQuestNames() {
        ...
        q0.executeUpdate();
        Query q1 = em.createNativeQuery("update translatedtext set status ='REVOKED' where spreadsheetsquestname_id in(select g.id from gspreadsheetsquestname g join esorawstring e on g.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=g.aid and e.bid=g.bid and e.cid=g.cid);");
        q1.executeUpdate();
        Query q2 = em.createNativeQuery("update gspreadsheetsquestname set texten=regexp_replace(e.texten,'\\n','$','g'),textru=regexp_replace(e.texten,'\\n','$','g'),changetime=null,translator=null,deprecated=false from esorawstring e where gspreadsheetsquestname.texten!=regexp_replace(e.texten,'\\n','$','g') and e.aid=gspreadsheetsquestname.aid and e.bid=gspreadsheetsquestname.bid and e.cid=gspreadsheetsquestname.cid;");
        q2.executeUpdate();
        Query q3 = em.createNativeQuery("insert into gspreadsheetsquestname (id,changetime,rownum,texten,textru,translator,weight,aid,bid,cid,deprecated) select nextval('hibernate_sequence'),null,null,regexp_replace(texten,'\\n','$','g') as ten,regexp_replace(texten,'\\n','$','g') as ter, null,cid,aid,bid,cid,FALSE from esorawstring where id in(select distinct min(e.id) from esorawstring e left join gspreadsheetsquestname g on lower(g.texten) = lower(regexp_replace(e.texten,'\\n','$','g')) where e.aid in(52420949) and g.id is null group by lower(e.texten));");
        q3.executeUpdate();
